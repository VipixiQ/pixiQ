...
export const solutionsNl: Solution[] = [
  {
    slug: "digital-signage-as-a-service",
    title: "Digital Signage as a Service",
    subtitle: "Turnkey digital signage oplossingen met meetbare impact",
    description:
      "End-to-end digital signage-oplossingen die hardware, software, content management en analytics combineren.",
    heroDescription:
    ...
    kpis: [
      { value: "400+", label: "Displays beheerd", description: "Over verschillende implementaties" },
      { value: "99.9%", label: "Uptime", description: "Betrouwbare performantie" },
      { value: "+35%", label: "Gem. engagementstijging", description: "Vergeleken met statische signage" },
    ],
    relatedCases: [],
  },
  {
    ...
    subtitle: "Audiovisuele belevingen die ruimtes transformeren",
    description:
      "Wij ontwerpen en realiseren audiovisuele belevingen die veranderen hoe mensen ruimtes ervaren en gebruiken.",
    heroDescription:
    ...
    kpis: [
      { value: "50+", label: "Experience projecten", description: "Ontworpen en gerealiseerd" },
      { value: "4.8/5", label: "Klantbeoordeling", description: "Gemiddelde tevredenheidsscore" },
      { value: "+60%", label: "Meer engagement", description: "Via interactieve ervaringen" },
    ],
    relatedCases: [],
  },
  {
    ...
    subtitle: "Datagedreven content op het juiste moment",
    description:
      "Ons intelligence platform combineert publieksanalyse, contentoptimalisatie en realtime rapportering.",
    heroDescription:
    ...
    kpis: [
      { value: "2M+", label: "Dagelijkse impressies", description: "Opgevolgd en geanalyseerd" },
      { value: "+28%", label: "Contenteffectiviteit", description: "Via data-optimalisatie" },
      { value: "Realtime", label: "Analytics", description: "Direct inzicht en rapportering" },
    ],
    relatedCases: [],
  },
  {
...
export function getSolutionNlBySlug(slug: string): Solution | undefined {
  return solutionsNl.find((solution) => solution.slug === slug)
}

export function getAllSolutionNlSlugs(): string[] {
  return solutionsNl.map((solution) => solution.slug)
}