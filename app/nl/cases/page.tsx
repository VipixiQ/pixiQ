...
export const metadata: Metadata = {
  title: "Cases",
  description:
    "Ontdek hoe pixiQ digitale belevingen creëert met meetbare impact voor klanten in verschillende sectoren.",
}
        ...
        <Container className="relative">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[#4b5563] sm:text-xl lg:text-[1.45rem]">
              Ontdek hoe pixiQ doelgerichte digitale belevingen creëert die
              communicatie versterken, bezoekers beter begeleiden en
              meetbare impact opleveren.
            </p>
          </div>
        </Container>
      </section>
      ...
      <Section>
        <div className="mb-10 lg:mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-heading text-foreground leading-tight max-w-2xl">
            Digitale belevingen in de praktijk
          </h2>
        </div>
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <h3 className="text-2xl lg:text-3xl font-heading text-foreground mb-5 group-hover:text-[#2c4d98] transition-colors">
                Een sterkere digitale guest experience doorheen de arena
              </h3>

              <p className="text-muted-foreground leading-relaxed mb-8">
                Een geïntegreerde digital signage-oplossing in de
                supportersinkom en VIP-omgeving, met indoor LED,
                interactieve displays en flexibele contentsturing voor een
                meer dynamische en professionele bezoekerservaring.
              </p>
